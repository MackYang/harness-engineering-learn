...
## 五大补充原则（2026-06-09 / 2026-06-23 基于 Anthropic + Addy Osmani 新文章提炼）
...
## 补充原则（2026-06-26 基于 Addy Osmani Agent Harness Engineering 提炼）

### 16. Harness 是活系统，不是一次性配置
模型提升时，harness 不缩小，而是**移动**。旧组件变 dead code 应移除，新天花板需要新脚手架。每个组件编码了一个"模型做不到"的假设。

### 17. Skill 创作 vs Plugin 分发
Skill 是项目的编写格式，Plugin 是跨项目的分发格式。打包 skills + connectors 为 plugin 让团队一键安装。

### 18. Success is silent, failures are verbose（成功静默，失败冗长）
Hook 反馈原则：检查通过时 Agent 什么都不听，失败时错误文本注入循环让 Agent 自纠。反馈循环在正常情况几乎零成本。
...
*最后更新：2026-06-26*
*来源：OpenAI Harness Engineering (2026-06) + Anthropic Engineering Blog + Addy Osmani Agent/Loop Engineering*
